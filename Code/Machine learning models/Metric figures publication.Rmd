...
```{r}
urlfile<-'https://raw.githubusercontent.com/skubleny/Integrated-Molecular-Classification-GC/main/Data/Final%20metrics%20data/compile_tcga_model_final.csv'
tcga_models<-read.csv(urlfile)
...
urlfile<-'https://raw.githubusercontent.com/skubleny/Integrated-Molecular-Classification-GC/main/Data/Final%20metrics%20data/compile_acrg_model.csv'
acrg_models<-read.csv(urlfile)
...
urlfile<-'https://raw.githubusercontent.com/skubleny/Integrated-Molecular-Classification-GC/main/Data/Final%20metrics%20data/compile_tme_models_final.csv'
tme_models<-read.csv(urlfile)
