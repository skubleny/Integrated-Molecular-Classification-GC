...
write.csv(combo_nanostring, "combo_nanostring_no67.csv")
...
paired_combo_nanostring_cancer = 
  group_by(combo_nanostring_cancer, patient_id) %>%
  filter(n() != 1) %>%
  arrange(tissue, patient_id) %>%
  ungroup()

wilcox.test(STAD_CIN ~ as.factor(tissue), data = paired_combo_nanostring_cancer, paired = TRUE)
wilcox.test(STAD_EBV ~ as.factor(tissue), data = paired_combo_nanostring_cancer, paired = TRUE)
wilcox.test(STAD_MSI ~ as.factor(tissue), data = paired_combo_nanostring_cancer, paired = TRUE)
wilcox.test(STAD_GS ~ as.factor(tissue), data = paired_combo_nanostring_cancer, paired = TRUE)
wilcox.test(High_cal ~ as.factor(tissue), data = paired_combo_nanostring_cancer, paired = TRUE)

paired_combo_nanostring_cancer = as.data.frame(paired_combo_nanostring_cancer)
paired_combo_nanostring_cancer$tissue = as.factor(paired_combo_nanostring_cancer$tissue)
paired_combo_nanostring_cancer$patient_id = as.factor(paired_combo_nanostring_cancer$patient_id)
 paired_combo_nanostring_cancer = paired_combo_nanostring_cancer[-20,]
```

#Paired boxplots
```{r}
library(ggpubr)
cin_organoid_parent = ggpaired(paired_combo_nanostring_cancer, x = "tissue", y = "STAD_CIN",
 color = "black", line.color = "patient_id", line.size = 1, fill="gray80") + 
  ylim(0,1) + 
  ylab("Probability CIN") +
  scale_x_discrete(name = "Gastric Cancer Sample", label = c("Parent Tissue", "Organoid")) +
  stat_compare_means(paired = TRUE, size=6,label.x=0.8, label.y=0.98) +
  geom_point(inherit.aes = FALSE, aes(x = tissue, y = STAD_CIN, fill= patient_id), shape=21,colour="black", size=4) +
   theme_bw() +
  ...
  theme(axis.title.x = element_text(colour="black", size =18, vjust = 0.05)) +
  theme(axis.title.y = element_text(colour="black", size=18)) +
  theme(strip.text = element_text(size=18)) +
  theme(legend.position = "none")
ggsave("cin_organoid_parent_final.svg", cin_organoid_parent, width=4, height=4)

ebv_organoid_parent = ggpaired(paired_combo_nanostring_cancer, x = "tissue", y = "STAD_EBV",
 color = "black", line.color = "patient_id", line.size = 1, fill="gray80") + 
  ylim(0,1) + 
  ylab("Probability EBV") +
  scale_x_discrete(name = "Gastric Cancer Sample", label = c("Parent Tissue", "Organoid")) +
  stat_compare_means(paired = TRUE, size=6, label.y=0.97, label.x=1.5) +
  geom_point(inherit.aes = FALSE, aes(x = tissue, y = STAD_EBV, fill= patient_id), shape=21,colour="black", size=4) +
    theme_bw() +
  theme(axis.text.x = element_text(colour="black", size = 18)) +
  theme(axis.text.y = element_text(colour="black",size = 16)) + 
  theme(plot.title = element_text(colour="black", size=18,hjust = 0, vjust=0)) +
  ...
  theme(strip.text = element_text(size=18)) +
  theme(legend.position = "none")
ggsave("ebv_organoid_parent_final.svg", ebv_organoid_parent, width=4, height=4)

MSI_organoid_parent = ggpaired(paired_combo_nanostring_cancer, x = "tissue", y = "STAD_MSI",
 color = "black", line.color = "patient_id", line.size = 1, fill="gray80") + 
  ylim(0,1) + 
  ylab("Probability TCGA MSI") +
  scale_x_discrete(name = "Gastric Cancer Sample", label = c("Parent Tissue", "Organoid")) +
  stat_compare_means(paired = TRUE, size=6, label.y=0.75) +
  geom_point(inherit.aes = FALSE, aes(x = tissue, y = STAD_MSI, fill= patient_id), shape=21,colour="black", size=4) +
   theme_bw() +
  theme(axis.text.x = element_text(colour="black", size = 18)) +
  theme(axis.text.y = element_text(colour="black",size = 16)) + 
  theme(plot.title = element_text(colour="black", size=18,hjust = 0, vjust=0)) +
  ...
  theme(strip.text = element_text(size=18)) +
  theme(legend.position = "none")
ggsave("MSI_organoid_parent_final.svg", MSI_organoid_parent, width=4, height=4)


GS_organoid_parent = ggpaired(paired_combo_nanostring_cancer, x = "tissue", y = "STAD_GS",
 color = "black", line.color = "patient_id", line.size = 1, fill="gray80") + 
  ylim(0,1) + 
  ylab("Probability GS") +
  scale_x_discrete(name = "Gastric Cancer Sample", label = c("Parent Tissue", "Organoid")) +
  stat_compare_means(paired = TRUE, size=6, label.y=0.95) +
  geom_point(inherit.aes = FALSE, aes(x = tissue, y = STAD_GS, fill= patient_id), shape=21,colour="black", size=4, show.legend=FALSE) +
  theme_bw() +
  theme(axis.text.x = element_text(colour="black", size = 18)) +
  theme(axis.text.y = element_text(colour="black",size = 16)) + 
  theme(plot.title = element_text(colour="black", size=18,hjust = 0, vjust=0)) +
  ...
  theme(axis.title.y = element_text(colour="black", size=18)) +
  theme(strip.text = element_text(size=18)) +
  theme(legend.title = element_text(hjust = .5,size=17),
        legend.position= c(0.5,0.7), 
        legend.direction = "horizontal",
        legend.text= element_text(size=17),
        legend.box.background = element_rect(size = 1.25, color = "black")) +
  guides(colour=guide_legend(title="Patient ID",title.position = "top"))
ggsave("GS_organoid_parent_final.svg", GS_organoid_parent, width=4, height=4)


High_organoid_parent = ggpaired(paired_combo_nanostring_cancer, x = "tissue", y = "High_cal",
 color = "black", line.color = "patient_id", line.size = 1, fill="gray80") + 
  ylim(0,1) + 
  ylab("Probability TME High") +
  scale_x_discrete(name = "Gastric Cancer Sample", label = c("Parent Tissue", "Organoid")) +
  stat_compare_means(paired = TRUE, size=6, label.y=0.95) +
  geom_point(inherit.aes = FALSE, aes(x = tissue, y = High_cal, fill= patient_id), shape=21,colour="black", size=4) +
  theme_bw() +
  theme(axis.text.x = element_text(colour="black", size = 18)) +
  theme(axis.text.y = element_text(colour="black",size = 16)) + 
  theme(plot.title = element_text(colour="black", size=18,hjust = 0, vjust=0)) +
  ...
  theme(strip.text = element_text(size=18)) +
  theme(legend.position = "none")
ggsave("High_organoid_parent_final.svg", High_organoid_parent, width=4, height=4)


```
#Subtype and pheno data
```{r}
library(lubridate)
...
pheno_data<-read.csv(urlfile,na.strings=c("",NA))

pheno_data = pheno_data %>% 
  mutate(
    OS_time = 
      as.duration(diagnosis_date %--% latest_follow_up) / dyears(1)
    )

colnames(pheno_data)[which(names(pheno_data) == "Patient..")] <- "sample_id"

pheno_data$tx_response_binary = ifelse(grepl("Near Complete", pheno_data$Treatment_Response, ignore.case = T), "response", 
                              ifelse(grepl("Complete", pheno_data$Treatment_Response, ignore.case = T), "response", 
                              ifelse(is.na(pheno_data$Treatment_Response), NA,"incomplete")))


pheno_data$Lymphovascular_invasion <- str_replace_all(pheno_data$Lymphovascular_invasion, c("no" = "Negative", "yes" = "Positive", "yrs" = "Positive"))
pheno_data$Perineural._invasion <- str_replace_all(pheno_data$Perineural._invasion, c("-" = NA, "N/A" = NA, "no" = "Negative", "yes" = "Positive", "yrs" = "Positive" ))
...
gene_specific_nanostring$sample_id = gsub("[^0-9.-]", "",gene_specific_nanostring$sample_id)

gene_specific_nanostring$sample_id = gsub("[[:punct:]]", " ", gene_specific_nanostring$sample_id)

gene_specific_nanostring

colnames(gene_specific_nanostring)[which(names(gene_specific_nanostring) == "sample_id")] <- "patient_id"
colnames(pheno_data)[which(names(pheno_data) == "sample_id")] <- "patient_id"


subtype_pheno = merge(gene_specific_nanostring, pheno_data, by = "patient_id")
write.csv(subtype_pheno, "subtype_pheno_no67.csv")

survival = coxph(Surv(OS_time, Uncensored) ~ STAD_CIN, data = subtype_pheno)
summary(survival)
survfit(Surv(OS_time, Uncensored) ~ STAD_CIN, data = subtype_pheno)
summary(survfit(Surv(OS_time, Uncensored) ~ STAD_CIN, data = subtype_pheno), times = 60)


survival = coxph(Surv(OS_time, Uncensored) ~ scale(STAD_CIN), data = subtype_pheno)
summary(survival)
survival = coxph(Surv(OS_time, Uncensored) ~ scale(STAD_GS), data = subtype_pheno)
summary(survival)
survival = coxph(Surv(OS_time, Uncensored) ~ scale(STAD_MSI), data = subtype_pheno)
summary(survival)
survival = coxph(Surv(OS_time, Uncensored) ~ scale(STAD_EBV), data = subtype_pheno)
summary(survival)
survival = coxph(Surv(OS_time, Uncensored) ~ scale(High_cal), data = subtype_pheno)
summary(survival)


ggsurvplot(survfit(Surv(OS_time, Uncensored) ~ TCGA_subtype, data = subtype_pheno))

ggsurvplot(survfit(Surv(OS_time, Uncensored) ~ TME_subtype, data = subtype_pheno))

###lauren Dunns
dunn_lauren_final = subtype_pheno %>%
  FSA::dunnTest(STAD_GS ~Lauren.Classification,data=.,method="bonferroni")
dunn_lauren_final = dunn_lauren_final$res
dunn_lauren_final$group1 = c("Diffuse","Diffuse","Intestinal")
dunn_lauren_final$group2 = c("Intestinal","Mixed","Mixed")
dunn_lauren_final$psymbol <- as.character(cut(dunn_lauren_final$P.adj, c(0, 0.0001, 0.001, 0.01, 0.05, 1), c("****", "***", "**", "*", "ns")))

nanostring_gs_lauren = subtype_pheno %>%
   filter(!is.na(Lauren.Classification))  %>%
  ggplot( aes(x = Lauren.Classification, y=STAD_GS)) +
     geom_boxplot(fill = c("#74ADD1","#FEE090" , "#F46D43" )) + 
  stat_compare_means(size=5, label.y =0.95) + 
    stat_pvalue_manual(data = dunn_lauren_final, label = "psymbol",xmin = "group1", xmax = "group2",y.position = c(  0.7,0.8,0.9), size = 7,tip.length =0.0) +
  ylim(0,1) +
  ylab("Genomically Stable") +
  xlab("Lauren Class") +
        theme_bw() +
...
ggsave("nanostring_gs_lauren_final.svg", nanostring_gs_lauren, width=4, height=3)


subtype_pheno$signet_ring_cell = as.factor(subtype_pheno$signet_ring_cell)
subtype_pheno$signet_ring_cell <- relevel(subtype_pheno$signet_ring_cell, "yes")

nanostring_gs_signet = subtype_pheno %>%
 filter(!is.na(signet_ring_cell))  %>%
  ggplot(aes(x = signet_ring_cell, y=STAD_GS)) +
     geom_boxplot(fill= c("#016C59", "#67A9CF")) + 
  stat_compare_means(size=5, label.y =0.95) + 
  ylim(0,1) +
  ylab("Genomically Stable") +
  scale_x_discrete(name="Signet Ring Cell", labels=c("Yes", "No")) +
        theme_bw() +
  ...
  theme(legend.title =element_blank(),
        legend.position="none")
ggsave("nanostring_gs_signet_final.svg", nanostring_gs_signet, width=4, height=3)

```

#SUMMARY TABLE 
```{r}
table1_ffpe = subtype_pheno

table1_ffpe$ecog <- str_replace_all(table1_ffpe$ecog, c("1-2" = "1"))
table1_ffpe$tumor.location <- str_replace_all(table1_ffpe$tumor.location, c("Distal " = "Distal", "Entire stomach" = "Whole stomach"))
table1_ffpe$H..Pylori.hx <- str_replace_all(table1_ffpe$H..Pylori.hx, c("unknown" = "Unknown", "negative" = "Negative", "no " = "Negative","no" = "Negative", "yes" = "Positive", "positive" = "Positive", "treated" = "Treated"))
table1_ffpe$H..Pylori.hx <- str_replace_all(table1_ffpe$H..Pylori.hx, c("UnkNegativewn" = "Unknown"))
table1_ffpe$H..Pylori.hx <- str_replace_all(table1_ffpe$H..Pylori.hx, c("Unknown" = NA))
table1_ffpe$H..Pylori.hx[ table1_ffpe$H..Pylori.hx == "Unknown" ] <- NA

table1_ffpe$SURGERY <- str_replace_all(table1_ffpe$SURGERY, c("Distal gastrectomy " = "Distal Gastrectomy","Distal Gastrectomy" = "Distal Gastrectomy", "Distal gastrectomy " = "Distal Gastrectomy", "Total gastrectomy " = "Total Gastrectomy"," Total gastrectomy" = "Total Gastrectomy", "Total gastrectomyD2"= "Total Gastrectomy"))
table1_ffpe$SURGERY <- str_replace_all(table1_ffpe$SURGERY, c("Distal gastrectomy" = "Distal Gastrectomy","Total gastrectomy" = "Total Gastrectomy"))
table1_ffpe$Smoker <- str_replace_all(table1_ffpe$Smoker, c("es" = "Yes"))
table1_ffpe$Smoker <- str_replace_all(table1_ffpe$Smoker, c("yYes" = "Yes"))

table1_ffpe$Lymphovascular_invasion <- str_replace_all(table1_ffpe$Lymphovascular_invasion, c("no" = "Negative", "yes" = "Positive", "yrs" = "Positive"))
table1_ffpe$Perineural._invasion <- str_replace_all(table1_ffpe$Perineural._invasion, c("-" = NA, "N/A" = NA, "no" = "Negative", "yes" = "Positive", "yrs" = "Positive" ))

table1_ffpe$Carcinomatosis <- str_replace_all(table1_ffpe$Carcinomatosis, c("postive" = "positive", "Liver mets" = "positive"))

library(flextable)
tb_chp5_demo= tbl_summary(table1_ffpe,
             percent = "column", 
             include=c("age", "sex","Stage", "Grade","tumor.location", "Lauren.Classification", "signet_ring_cell", "tumor.location")) %>% 
   remove_row_type(variables = everything(),type = "missing") %>% 
   add_n(col_label="**n/N (Missing %)**", statistic= "{n} / {N} ({p_miss}%)", add_footnote = "Percent") 
 
tb_chp5_demo_flex = as_flex_table(
  tb_chp5_demo,
  include = everything(),
  return_calls = FALSE,
  strip_md_bold = TRUE
